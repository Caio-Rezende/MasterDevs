...
export function NavView() {
  ...
  return (
    <nav
      className="text-yellow-600 p-4 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 xl:grid-cols-1 gap-4 text-xl xl:text-2xl bg-black" 
    ...
    >
      ...
      <MenuItem anchor="playground" onClick={stopDisplay} display={display} />
      <MenuItem anchor="blog" onClick={stopDisplay} display={display} />
      <MenuItem anchor="version" onClick={stopDisplay} display={display} />
