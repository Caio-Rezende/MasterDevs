...
export function NavView() {
  ...
  return (
    <nav
      className="text-yellow-600 p-4 grid grid-cols-2 xl:grid-cols-1 hover:grid-cols-2 sm:hover:grid-cols-5 xl:hover:grid-cols-1 gap-4 text-xl xl:text-2xl group"
      ref={navRef}
    >
